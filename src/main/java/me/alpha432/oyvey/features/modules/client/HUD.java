...
public class HUD extends Module {
    ...
    private final Setting<Boolean> versionNumber = register(new Setting("VersionNumber", Boolean.valueOf(true), v -> this.waterMark.getValue().booleanValue()));
    ...
    public HUD() {
        super("LegacyHUD", "HUD Elements rendered on your screen", Module.Category.CLIENT, true, false, false);
        setInstance();
    }
