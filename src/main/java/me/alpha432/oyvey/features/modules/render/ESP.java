...
public class ESP
    ...
    private final Setting<Boolean> interpolate = this.register(new Setting<Boolean>("Interpolate", true));
        ...
        if (this.items.getValue().booleanValue()) {
            ...
            for (Entity entity : ESP.mc.world.loadedEntityList) {
                ...
                if (interpolate.getValue()) {
                    ...
                    interp = new Vec3d(entity.posX - mc.getRenderManager().viewerPosX, entity.posY - mc.getRenderManager().viewerPosY, entity.posZ - mc.getRenderManager().viewerPosZ);
                }
